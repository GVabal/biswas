...
public class WorkflowSetup {
    ...
    public WorkflowStep getFirstStepForStage(Stage stage) {
        return switch (stage) {
            ...
            case LC_AGREEMENT_WORKFLOW -> LeasingCoreAgreementCreationWorkflow.LeasingCoreAgreementCreationStep.VALIDATE_SOC_DATA;
            case AGREEMENT_DOCUMENT_WORKFLOW -> AgreementDocumentCreationWorkflow.AgreementDocumentCreationStep.REQUEST_TO_GENERATE_DOCUMENT;
            default -> null;
        };
    }
}
